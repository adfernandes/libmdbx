...
Новое:
 ...
 - Основной репозиторий libmdbx перенесен с Gitflic на SourceCraft, а зеркала на Github больше нет.
   ...
   Со своей стороны, я удручен необходимостью совершать такие манипуляции, ибо они создают существенные неудобства пользователям, но (к сожалению) для того есть достаточные причины:
     ...
     - После снятия блокировки на Github я пошел на встречу пользователям и восстановил репозиторий на Github в режиме зеркала. Однако, многие разработчики и проекты не стали как-либо налаживать взаимодействие и соблюдать условия лицензии, а отошли от правил честной сделки, стали удалять/вымарывать уведомления об использовании libmdbx, и даже корректировать/удалять ссылки на сайт проекта. Поэтому я решил закрыть зеркало на Github.
